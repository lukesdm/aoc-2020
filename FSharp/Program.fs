...
let main argv =
    ...
    let result: Object =
        ...
        | "11" ->
            ...
            let input = File.ReadAllText "day11.txt"

            Day11.solve (input.TrimEnd()) :> Object
        // Skip a few
        | "14" ->
        ...
        // Skip some more
        | "17" ->
            let _ = runTestsWithCLIArgs [] [||] Day17.tests

            let input = File.ReadAllText "day17.txt"

            Day17.solve (input.TrimEnd()) :> Object
        // ...
        | "24" ->
